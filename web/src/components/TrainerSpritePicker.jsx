...
const TRAINER_SPRITES = [
  ...
  { id: 'team-rocket-grunt', label: 'Team Rocket', url: `${SHOWDOWN_BASE}/teamrocketgruntm.png` },
  { id: 'team-magma-grunt', label: 'Team Magma', url: `${SHOWDOWN_BASE}/teammagmagruntm.png` },
  { id: 'team-aqua-grunt', label: 'Team Aqua', url: `${SHOWDOWN_BASE}/teamaquagruntm.png` },
  { id: 'team-galactic-grunt', label: 'Team Galactic', url: `${SHOWDOWN_BASE}/teamgalacticgruntm.png` },
  { id: 'team-plasma-grunt', label: 'Team Plasma', url: `${SHOWDOWN_BASE}/teamplasmagruntm.png` },
  { id: 'team-skull-grunt', label: 'Team Skull', url: `${SHOWDOWN_BASE}/teamskullgruntm.png` },
  { id: 'team-yell-grunt', label: 'Team Yell', url: `${SHOWDOWN_BASE}/teamyellgruntm.png` },
  { id: 'ace-trainer-m', label: 'Ace Trainer (M)', url: `${SHOWDOWN_BASE}/acetrainerm.png` },
  ...
  { id: 'ranger-m', label: 'Ranger (M)', url: `${SHOWDOWN_BASE}/pokemonrangerm.png` },
  ...
  { id: 'swimmer-m', label: 'Swimmer (M)', url: `${SHOWDOWN_BASE}/swimmerm.png` },
  ...
  { id: 'psychic-m', label: 'Psychic (M)', url: `${SHOWDOWN_BASE}/psychicm.png` },
  { id: 'psychic-f', label: 'Psychic (F)', url: `${SHOWDOWN_BASE}/psychicf.png` },
  { id: 'blackbelt', label: 'Black Belt', url: `${SHOWDOWN_BASE}/blackbelt.png` },
  { id: 'hex-maniac', label: 'Hex Maniac', url: `${SHOWDOWN_BASE}/hexmaniac.png` },
  { id: 'veteran-m', label: 'Veteran (M)', url: `${SHOWDOWN_BASE}/veteranm.png` },
  ...
  { id: 'channeler', label: 'Channeler', url: `${SHOWDOWN_BASE}/channeler.png` },
  { id: 'cooltrainer-m', label: 'Cooltrainer (M)', url: `${SHOWDOWN_BASE}/cooltrainerm.png` },
  { id: 'cooltrainer-f', label: 'Cooltrainer (F)', url: `${SHOWDOWN_BASE}/cooltrainerf.png` },
];
